...
public class UpdateBillRequest {
    ...
    public UpdateBillRequest(Long id, Integer categoryId, String amount, Integer direction,
                             String remark, String billDate, Integer consumptionType,
                             String paymentMethod, String billTime) {
        this.id = id;
